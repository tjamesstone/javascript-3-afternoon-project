...
//Code Here
var evenNumbers = mixedNumbers.filter(function(el, i, arr){
  if (el %2 === 0) {
    return true
  } else {
    return false
...
//Code Here
let postTaxPrices = prices.map(function(el, index, arr){
  return el *1.07
})
...
let orderTotals = orders.map(function(el, index, arr){
